...
<style>
    ...
    /* 2. ANIMASI GAMBAR */
    .pilih-room-img-wrap { height: 230px; background: #0f172a; position: relative; display: flex; justify-content: center; align-items: center; border-bottom: 1px solid #334155; overflow: hidden; }
...
<div class="pilih-container">
    ...
    <div style="max-width: 800px; margin: 0 auto 50px auto; padding: 0 20px;">
        <div style="position: relative;">
            <i class="fa-solid fa-magnifying-glass" style="position: absolute; left: 20px; top: 18px; color: #f97316; font-size: 1.2rem;"></i>
    ...
    <div class="pilih-room-grid" id="search-grid" style="display: none;">
        </div>
</div>
